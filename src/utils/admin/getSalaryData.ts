...
export default function getSalaryData(data: SalaryData) {
    ...
    let overWorkSalary = isOverWork ? (ranksSalary[rank].overWork || 0) * overWorkTime : 0
    ...
    return {calculatedWorkingTime, calculatedOverWorkTime, overWorkSalary, salary, bonuses}
}